    ...
    render() {
        ...
        const columns = [
            ...
            { data: 6, title: t('enabled'), render: data => data ? t('yes') : t('no'), searchable: false},
            {
                actions: data => {
                    ...
                    if (clikerConfig.globalPermissions.setupAutomation && this.props.campaign.permissions.includes('manageTriggers')) {
                        actions.push({
        ...
        return (
            <div>
                ...
                {clikerConfig.globalPermissions.setupAutomation && this.props.campaign.permissions.includes('manageTriggers') &&
                    <Toolbar>
