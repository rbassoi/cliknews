...
export function getTemplateTypes(t, prefix = '', entityTypeId = ResourceType.TEMPLATE, allowEmpty = false) {
    ...
    const mosaicoFsTemplatesOptions = clikerConfig.mosaico.fsTemplates;
    const mosaicoFsTemplatesLabels = new Map(clikerConfig.mosaico.fsTemplates.map(({key, label}) => ([key, label])));
    ...
    templateTypes.mosaicoWithFsTemplate = {
        ...
        initData: () => ({
            [prefix + 'mosaicoFsTemplate']: clikerConfig.mosaico.fsTemplates[0].key,
            [prefix + 'mosaicoData']: {}
        }),
        afterLoad: data => {
                ...
                <div style={{marginTop: '15px'}}>
                    ...
                    <table className="table table-bordered table-condensed table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <Trans i18nKey="clikerCustomTagsTheCustomTagsCanBe">Cliker custom tags. The custom tags can be passed in via <code>mt:entries-json</code> element in RSS entry. The text contents of the elements is interpreted as JSON-formatted object..</Trans>
                            </td>
                        </tr>
                        </tbody>
                    </table>
